    ...
    <div className="home-container">
      ...
      <section className="hero">
        <div className="hero-overlay">
          ...
          <Link to="/Properties" className="hero-btn">Browse Listings</Link>
        </div>
      </section>
      ...
      <div className="stats-content-wrapper">
        <div className="stats-text-area">
          ...
          <h2 className="stats-main-heading">
            We are committed to offering exceptional insights, guidance, and assistance at every stage of your real estate journey.
          </h2>
        </div>

        <div className="stats-line-divider"></div> {/* The horizontal line */}
      ...
      <div className="cta-left-column">
        <div className="cta-content">
          ...
          <p className="cta-description">
            Explore our extensive listings of homes for sale. From cozy apartments to luxurious estates,
            we have a property that fits your lifestyle and budget.
          </p>
          {/* You can add a link/button here if you want to navigate to the "For Sale" page */}
          {/* <a href="/properties/for-sale" className="cta-button">View For Sale</a> */}
        </div>
      </div>

      {/* Right Column: For Rent */}
      <div className="cta-right-column">
        <div className="cta-content">
          <h2 className="cta-heading">DISCOVER RENTAL OPPORTUNITIES</h2>
          <p className="cta-description">
            Looking for a rental? Browse through our curated selection of properties available for rent,
            from short-term leases to long-term residencies.
          </p>
          {/* You can add a link/button here if you want to navigate to the "For Rent" page */}
          {/* <a href="/properties/for-rent" className="cta-button">View For Rent</a> */}
        </div>
      </div>
    </section>
